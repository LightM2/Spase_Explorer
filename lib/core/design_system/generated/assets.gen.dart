...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/launches.svg
  SvgGenImage get launches => const SvgGenImage('assets/icons/launches.svg');

  /// File path: assets/icons/news.svg
  SvgGenImage get news => const SvgGenImage('assets/icons/news.svg');

  /// List of all assets
  List<SvgGenImage> get values => [events, launches, news];
}
